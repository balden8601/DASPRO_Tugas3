...
//variabel yang akan digunakan//
var i,b,c:integer;
//start atau body program//

begin
//untuk membuat segitiga keatas menggunakan 'to'//
    for i:= 1 to 7 do
        begin
            for b:= 1 to 7-i do
                begin
...
//untuk membuat segitiga menghadap kebawah(terbalik) menggunakan 'downto'//
    for i:=(7-1) downto 1 do
        begin
            for b:=1 to 7-i do
                begin
                    write(' ');
